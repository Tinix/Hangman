defmodule TextClient.Impl.Player do
  ...
  def interact({_game, _tally = %{game_state: :lost}}) do
    IO.puts("Sorry, you lost... the word was: #{@game.letters |> Enum.join()}") # TODO: Add Hangman.letters
  end
  ...
  def feedback_for(%{game_state: :already_used}), do: "You've already used that letter."
